					...
					"config": {
						"inbounds": {
							"Mandate-display": {
								...
								"action": "display",
								"description": "HCM Mandate custom application",
								"title": "Mandate",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sio.hcm.mandate",
									"url": sap.ui.require.toUrl("sio/hcm/mandate")
								}
							}
						}
					}
